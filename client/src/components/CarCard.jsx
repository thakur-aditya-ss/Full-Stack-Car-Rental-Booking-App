...
const CarCard = ({car}) => {
  ...
  return (
    <div onClick={()=> {navigate(`/car-details/${car._id}`); scrollTo(0,0)}} className='group bg-white rounded-2xl overflow-hidden shadow-md card-hover border border-borderColor cursor-pointer'>
